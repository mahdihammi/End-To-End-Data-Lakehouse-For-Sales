...
WHEN NOT MATCHED THEN INSERT (
    ...
    governorate, postal_code, region, product_id, category,
...
VALUES (
    ...
    s.customer_id, s.customer_name, s.segment, s.country, s.city,
    s.governorate, s.postal_code, s.region, s.product_id, s.category,
    s.sub_category, s.product_name, s.sales, s.quantity, s.discount,
    s.profit, s.updated_at,
    s.load_date                  
);